    ...
    <form action="api/create_lead_process.php" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" id="reminder" name="reminder_date" required
                       placeholder=""
                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            </div>
        </div>
            ...
            <div>
                ...
                <select id="source" name="source" required
                    ...
                    <?php foreach($sources as $s): ?>
                        <option value="<?= $s ?>" <?= ($s == 'Website' ? 'selected' : '') ?>>
                            <?= $s ?>
                        </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="pt-4">
            <label for="campaign_id" class="text-sm font-medium text-gray-700 block">Associated Campaign (Optional)</label>
            ...
            <p class="mt-1 text-xs text-gray-500">If this lead was generated by a specific marketing campaign, select it here for ROI tracking.</p>
        </div>
        <div>
        ...
        <div class="pt-5 border-t border-gray-200 mt-8">
            <div class="flex justify-end">
                <a href="leads.php" class="bg-gray-200 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-300 transition">
                    Cancel
                </a>
