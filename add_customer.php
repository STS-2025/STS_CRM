    ...
    <form action="api/add_customer_process.php" method="POST" class="space-y-6">
        ...
        <div class="pt-5 border-t border-gray-200 mt-8">
            <div class="flex justify-end">
                ...
                <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-GREEN-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-GREEN-500">
